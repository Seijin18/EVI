...
Remote, human-in-the-loop code execution: WhatsApp/Telegram control chat can propose and approve development tasks that run against a pluggable CLI backend (Claude Code by default), never merging automatically.
